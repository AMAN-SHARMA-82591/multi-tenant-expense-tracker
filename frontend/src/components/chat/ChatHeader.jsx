...
const ChatHeader = ({ chat }) => {
  ...
  return (
    <div className="flex items-center justify-between p-4 border-b dark:border-gray-700 dark:bg-gray-800 border-gray-200 bg-white">
      <div className="flex items-center space-x-3">
        ...
        <div className="relative">
          {isGroup ? (
            ...
            <div className="relative">
              ...
              {chat.status && (
                <div
                  className={`absolute -bottom-1 -right-1 w-3 h-3 rounded-full border-2 dark:border-gray-800 border-white ${getStatusColor(
                    chat.status
                  )}`}
                />
              )}
        ...
        <div className="flex-1 min-w-0">
          <h3 className="font-semibold text-lg truncate dark:text-white text-gray-900">
            {getDisplayName()}
          </h3>
      ...
      <div className="flex items-center space-x-2">
        ...
        <div className="relative">
          ...
          {/* Dropdown Menu */}
          {showMenu && (
            <div className="absolute right-0 top-full mt-2 w-48 rounded-lg shadow-lg border dark:bg-gray-800 dark:border-gray-700 bg-white border-gray-200 z-50">
              <div className="py-1">
                {isGroup && (
                  <>
                    <button className="w-full text-left px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-gray-300 text-gray-700">
                      View group info
                    </button>
                    <button className="w-full text-left px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-gray-300 text-gray-700">
                      Add members
